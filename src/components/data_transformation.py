...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        Returns:
            ColumnTransformer object with numerical and categorical pipelines
        """
        try:
            # Define numerical and categorical columns
            numerical_columns = ["is_weekend","is_peak_hour","trip_distance_km","passenger_count","surge_multiplier"]
            categorical_columns = [
                "ride_type","vehicle_type","weather","traffic_level" 
            ]
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        Returns:
            Tuple of (train_array, test_array, preprocessor_file_path)
        """
        try:
